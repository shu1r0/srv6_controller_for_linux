...
def setup():
    ...
    r2.cmd("cd ..; python3 srv6_agent.py -v --ip 0.0.0.0 --port 30000 --log_file test2_r1.log &")
    ...
    r3.cmd("cd ..; python3 srv6_agent.py -v --ip 0.0.0.0 --port 30000 --log_file test2_r1.log &")
    ...
    r4.cmd("cd ..; python3 srv6_agent.py -v --ip 0.0.0.0 --port 30000 --log_file test2_r1.log &")
